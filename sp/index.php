	...
	<body>
		...
		<div id="nav">
			<div class="togglebtn">
				...
				<div id="menu">
					<ul>
						<li><a id="about" href="./about/">光陽祭について</a></li>
						<li><a id="floormap" href="./map/">会場マップ</a></li>
						<li><a id="exhibition" href="./exhibition/">出展企画</a></li>
						<li><a id="stage" href="./stage/">体育館ステージ</a></li>
						<li id="right"><a id="attention" href="./notice/">注意事項</a></li>
					</ul>
				</div>
			</div>
		</div>
